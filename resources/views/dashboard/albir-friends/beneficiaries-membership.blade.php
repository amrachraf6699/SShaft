...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('translation.albir_friends') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('translation.beneficiaries_membership') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
				...
				<div class="row row-sm">
					...
					<div class="col-md-12">
						<div class="card card-primary">
							<div class="card-body">
                                {!! Form::open(['route' => ['dashboard.albir-friends.beneficiaries-membership.update', $beneficiaries_membership->key], 'method' => 'post', 'files' => true]) !!}
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('how_to_join', old('how_to_join', $beneficiaries_membership->how_to_join), ['class' => 'form-control summernote', 'rows' => 4]) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('joining_terms', old('joining_terms', $beneficiaries_membership->joining_terms), ['class' => 'form-control summernote', 'rows' => 4]) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('membership_benefits', old('membership_benefits', $beneficiaries_membership->membership_benefits), ['class' => 'form-control summernote', 'rows' => 4]) !!}
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="file" name="img" class="dropify" data-default-file="{{ $beneficiaries_membership->image_path }}" accept=".jpg, .png, image/jpeg, image/png" data-height="70" />
