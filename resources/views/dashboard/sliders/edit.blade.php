...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('dashboard.sliders') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.update') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mg-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('type', ['home' => 'home', 'section' => "section"], old('type', $slider->type), ['class' => 'form-control select2']) !!}
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-lg-3">
                                        <label class="rdiobox">
                                            {!! Form::radio('status', 'active', (old('status', $slider->status)) == 'active' ? 'checked' : '') !!}
                                            <span>{{ __('translation.active') }}</span>
                                        </label>
                                    </div>
                                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                        <label class="rdiobox">
                                            {!! Form::radio('status', 'inactive', (old('status', $slider->status)) == 'inactive' ? 'checked' : '') !!}
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-lg-3">
                                        <label class="rdiobox">
                                            {!! Form::radio('quick_donation', 'yes', (old('quick_donation', $slider->quick_donation)) == 'yes' ? 'checked' : '') !!}
                                            <span>{{ __('translation.yes') }}</span>
                                        </label>
                                    </div>
                                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                        <label class="rdiobox">
                                            {!! Form::radio('quick_donation', 'no', (old('quick_donation', $slider->quick_donation)) == 'no' ? 'checked' : '') !!}
                                ...
                                <div class="row mg-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('service_id', ['' => trans('translation.service')] + $services->toArray(), old('service_id', $slider->service_id), ['class' => 'form-control select2']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('url', old('url', $slider->url), ['class' => 'form-control']) !!}
