...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('translation.unpaid_donations') }}</h4>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
...
@section('content')
				...
				<div class="row row-sm">
					<!--div-->
					<div class="col-md-12">
                        @include('dashboard.unpaid-donations.filter.filter')
						<div class="card card-primary">
							<div class="card-header py-3 d-flex">
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('dashboard.unpaid-donations.export') }}" class="btn btn-purple btn-with-icon mr-2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-icon-list">
                                                            ...
                                                            {{-- donation invoice --}}
                                                            <a href="{{ route('dashboard.unpaid-donations.edit', $donation->id) }}" class="btn btn-primary btn-icon"><i class="typcn typcn-pencil"></i></a>
                                                            {{-- donation delete --}}
                                                            <form action="{{ route('dashboard.unpaid-donations.destroy', $donation->id) }}" method="post" style="display: inline-block">
                                                                @csrf
                                                                @method('DELETE')
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('dashboard.unpaid-donations.destroy_all') }}" method="POST">
                        @csrf
                        @method('DELETE')
