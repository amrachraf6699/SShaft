<div class="card card-primary">
    <div class="card-body">
        {!! Form::open(['route' => 'dashboard.unpaid-donations.index', 'method' => 'get']) !!}
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('dashboard.unpaid-donations.index') }}" class="btn btn-secondary mr-2">{{ __('dashboard.reset') }}</a>
                    </div>
                </div>
