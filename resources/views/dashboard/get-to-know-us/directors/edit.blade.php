...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('translation.board_of_directors') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.update') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card card-primary">
                            <div class="card-body">
                                {!! Form::open(['route' => ['dashboard.directors.update', $director->id], 'method' => 'post', 'files' => true]) !!}
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('adjective', old('adjective', $director->adjective), ['class' => 'form-control']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('name', old('name', $director->name), ['class' => 'form-control']) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('job_title', old('job_title', $director->job_title), ['class' => 'form-control']) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('facebook_link', old('facebook_link', $director->facebook_link), ['class' => 'form-control']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('twitter_link', old('twitter_link', $director->twitter_link), ['class' => 'form-control']) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('instagram_link', old('instagram_link', $director->instagram_link), ['class' => 'form-control']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('linkedin_link', old('linkedin_link', $director->linkedin_link), ['class' => 'form-control']) !!}
                                ...
                                <div class="row pt-4">
                                    <div class="col-12">
                                        ...
                                        <input type="file" name="img" class="dropify"  data-default-file="{{ $director->image_path }}" accept=".jpg, .png, image/jpeg, image/png" data-height="70" />
