...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('translation.blogs') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.add') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                {!! Form::open(['route' => 'dashboard.blogs.store', 'method' => 'post', 'files' => true]) !!}
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            {!! Form::label('blog_section_id', trans('translation.section')) !!}
                                            {!! Form::select('blog_section_id', ['' => trans('translation.select')] + $sections->toArray(), old('blog_section_id'), ['class' => 'form-control select2']) !!}
