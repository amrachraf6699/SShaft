<div class="card card-primary">
    <div class="card-body">
        {!! Form::open(['route' => 'dashboard.donors.index', 'method' => 'get']) !!}
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-2 col-6">
                    <div class="form-group">
                        {!! Form::select('status', ['' => trans('dashboard.status'), 'active' => trans('dashboard.active'), 'inactive' => trans('dashboard.inactive'), ], old('status', request()->input('status')), ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-md-2 col-6">
                    <div class="form-group">
