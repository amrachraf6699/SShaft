...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('translation.users') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.update') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                {!! Form::open(['route' => ['dashboard.users.update', $user->id], 'method' => 'post']) !!}
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::email('email', old('email', $user->email), ['class' => 'form-control', 'autocomplete' => 'email']) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('user_status', ['active' => trans('dashboard.active'), 'inactive' => trans('dashboard.inactive'), ], old('user_status', $user->user_status), ['class' => 'form-control']) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="branch_id" class="form-control select2" required>
                                                @php
                                                    ...
                                                    $user_branch = \App\Branch::where('id', $user->branch_id)->get();
                                                @endphp
                                                
                                                <option value="{{ $user->branch_id }}" selected>{{ \App\Branch::find($user->branch_id)->first()->name }}</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::tel('phone', old('phone', $user->phone), ['class' => 'form-control']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('gender', ['' => trans('translation.select'), 'male' => trans('translation.male'), 'female' => trans('translation.female'), ], old('gender', $user->gender), ['class' => 'form-control']) !!}
