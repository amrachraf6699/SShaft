        ...
        {!! Form::open(['route' => 'dashboard.users.index', 'method' => 'get']) !!}
            <div class="row">
                ...
                <div class="col-md-2 col-6">
                    <div class="form-group">
                        {!! Form::select('user_status', ['' => trans('dashboard.user_status'), 'active' => trans('dashboard.active'), 'inactive' => trans('dashboard.inactive'), ], old('user_status', request()->input('user_status')), ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-md-2 col-6">
                    <div class="form-group">
                        {!! Form::select('sort_by', ['' => trans('dashboard.sort_by'), 'user_group_id' => trans('translation.user_groups'), 'created_at' => trans('dashboard.created_at')], old('sort_by', request()->input('sort_by')), ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-md-2 col-6">
                    <div class="form-group">
