<div class="card card-primary">
    <div class="card-body">
        {!! Form::open(['route' => 'dashboard.general-assembly-members.index', 'method' => 'get']) !!}
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-2 col-6">
                    <div class="form-group">
                        {!! Form::select('status', ['' => trans('dashboard.status'), 'active' => trans('dashboard.active'), 'pending' => trans('translation.pending'), 'inactive' => trans('dashboard.inactive'), ], old('status', request()->input('status')), ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-md-2 col-6">
                    <div class="form-group">
                        {!! Form::select('sort_by', ['' => trans('dashboard.sort_by'), 'package_id' => trans('translation.package_id'), 'created_at' => trans('dashboard.created_at')], old('sort_by', request()->input('sort_by')), ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-md-2 col-6">
                    <div class="form-group">
