...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('translation.general_assembly_members') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.add') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                {!! Form::open(['route' => 'dashboard.general-assembly-members.store', 'method' => 'post', 'files' => true]) !!}
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            {!! Form::label('package_id', trans('translation.section')) !!}
                                            {!! Form::select('package_id', ['' => trans('translation.select')] + $packages->toArray(), old('package_id'), ['class' => 'form-control select2']) !!}
                                ...
                                <div class="row mg-t-40 mg-b-40">
                                    ...
                                    <div class="col-lg-3">
                                        <label class="rdiobox">
                                            {!! Form::radio('gender', 'male', false, [old('gender')]) !!}
                                            <span>{{ __('translation.male') }}</span>
                                        </label>
                                    </div>
                                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                        <label class="rdiobox">
                                            {!! Form::radio('gender', 'female', false, [old('gender')]) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('payment_ways', ['bank_transfer' => trans('translation.bank_transfer'), 'credit_card' => trans('translation.credit_card'), ], old('payment_ways'), ['class' => 'form-control']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('status', ['active' => trans('dashboard.active'), 'pending' => trans('translation.pending'), 'awaiting_payment' => trans('translation.awaiting_payment'), 'inactive' => trans('dashboard.inactive')], old('status'), ['class' => 'form-control']) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::date('subscription_date', old('subscription_date'), ['class' => 'form-control']) !!}
                                ...
                                <div class="row pt-4">
                                    <div class="col-12">
                                        ...
                                        <input type="file" name="attachments" class="dropify" accept=".jpg, .png, image/jpeg, image/png" data-height="70" />
                                ...
                                <div class="row mg-t-40 mg-b-40">
                                    <div class="col-lg-2 mg-t-20 mg-lg-t-0 tx-bold">
                                        {!! Form::label('send_invoice', trans('translation.send_invoice')) !!}
                                    </div>
                                    <div class="col-lg-2">
                                        <label class="rdiobox">
                                            {!! Form::radio('send_invoice', 'yes', true, [old('send_invoice')]) !!}
                                            <span>{{ __('translation.yes') }}</span>
                                        </label>
                                    </div>
                                    <div class="col-lg-2 mg-t-20 mg-lg-t-0">
                                        <label class="rdiobox">
                                            {!! Form::radio('send_invoice', 'no', false, [old('send_invoice')]) !!}
                                            <span>{{ __('translation.no') }}</span>
                                        </label>
                                    </div>
                                    @error('send_invoice')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
