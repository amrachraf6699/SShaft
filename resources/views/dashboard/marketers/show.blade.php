				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
                            ...
                            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a href="{{ route('dashboard.marketers.show', $marketer->id) }}">{{ $marketer->full_name }} ({{ $marketer->username }})</a></span>
                            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.show') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
...
@section('content')
                    ...
                    <div class="col-md-4">
                        <div class="card card-primary">
                            <div class="card-body text-center">
                                <h3 class="title text-muted">{{ __('translation.Total donations received') }}</h3>
                                <h3 class="title">{{ $total }} <br> {{ __('translation.SAR') }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card card-primary">
                            <div class="card-body text-center">
                                <h3 class="title text-muted">{{ __('translation.paid_donations') }}</h3>
                                <h3 class="title">{{ $paid }} <br> {{ __('translation.SAR') }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card card-primary">
                            <div class="card-body text-center">
                                <h3 class="title text-muted">{{ __('translation.unpaid_donations') }}</h3>
                                <h3 class="title">{{ $unpaid }} <br> {{ __('translation.SAR') }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
				...
				<div class="row row-sm">
					<!--div-->
					<div class="col-md-12">
                        @include('dashboard.marketers.filter.donations-filter')
						<div class="card card-primary">
