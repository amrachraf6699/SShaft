...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('translation.seasonal_projects') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.update') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                        ...
                        <div class="card card-primary">
                            <div class="card-header py-3 d-flex">
                                <div class="d-flex justify-content-between">
                                    <a href="{{  route('dashboard.seasonal-projects.index') }}" class="btn btn-primary btn-with-icon btn-block">
                                        {{ __('translation.seasonal_projects') }}
                                    </a>
                                </div>
                            </div>
                            <div class="card-body">
                                {!! Form::open(['route' => ['dashboard.seasonal-projects.update', $project->id], 'method' => 'post', 'files' => true]) !!}
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('title', old('title', $project->title), ['class' => 'form-control']) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('content', old('content', $project->content), ['class' => 'form-control summernote', 'rows' => 4]) !!}
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-lg-3">
                                        <label class="rdiobox">
                                            {!! Form::radio('status', 'active', (old('status', $project->status)) == 'active' ? 'checked' : '') !!}
                                            <span>{{ __('translation.active') }}</span>
                                        </label>
                                    </div>
                                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                        <label class="rdiobox">
                                            {!! Form::radio('status', 'inactive', (old('status', $project->status)) == 'inactive' ? 'checked' : '') !!}
                                ...
                                <div class="row pt-4">
                                    <div class="col-12">
                                        ...
                                        <br>
                                        <input type="file" name="img" class="dropify" data-default-file="{{ $project->image_path }}" accept=".jpg, .png, image/jpeg, image/png" data-height="70" />
