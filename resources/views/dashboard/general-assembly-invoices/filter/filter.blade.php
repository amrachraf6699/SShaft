<div class="card card-primary">
    <div class="card-body">
        {!! Form::open(['route' => 'dashboard.general-assembly-invoices.index', 'method' => 'get']) !!}
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-1 col-6">
                    <div class="form-group">
                        {!! Form::select('invoice_status', ['' => trans('translation.invoice_status'), 'paid' => trans('translation.paid'), 'unpaid' => trans('translation.unpaid'), ], old('invoice_status', request()->input('invoice_status')), ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-md-1 col-6">
                    <div class="form-group">
