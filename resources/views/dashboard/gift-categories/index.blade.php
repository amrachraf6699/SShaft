...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('translation.gift_categories') }}</h4>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
...
@section('content')
				...
				<div class="row row-sm">
					<!--div-->
					<div class="col-md-12">
                        @include('dashboard.gift-categories.filter.filter')
						<div class="card card-primary">
							<div class="card-header py-3 d-flex">
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('dashboard.gift-categories.create') }}" class="btn btn-primary btn-with-icon btn-block">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-icon-list">
                                                            {{-- branch edit --}}
                                                            <a href="{{ route('dashboard.gift-categories.edit', $category->id) }}" class="btn btn-primary btn-icon"><i class="typcn typcn-pencil"></i></a>
                                                            {{-- branch delete --}}
                                                            <form action="{{ route('dashboard.gift-categories.destroy', $category->id) }}" method="post" style="display: inline-block">
                                                                @csrf
                                                                @method('DELETE')
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('dashboard.gift-categories.destroy_all') }}" method="POST">
                        @csrf
                        @method('DELETE')
