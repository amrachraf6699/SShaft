...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('dashboard.partners') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.update') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                        ...
                        <div class="card card-primary">
                            <div class="card-header py-3 d-flex">
                                <div class="d-flex justify-content-between">
                                    <a href="{{  route('dashboard.partners.index') }}" class="btn btn-primary btn-with-icon btn-block">
                                        <i class="las la-partners ml-1"></i>  {{ __('dashboard.partners') }}
                                    </a>
                                </div>
                            </div>
                            <div class="card-body">
                                {!! Form::open(['route' => ['dashboard.partners.update', $partner->id], 'method' => 'post', 'files' => true]) !!}
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('content', old('content', $partner->content), ['class' => 'form-control summernote', 'rows' => 4]) !!}
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-lg-3">
                                        <label class="rdiobox">
                                            {!! Form::radio('status', 'active', (old('status', $partner->status)) == 'active' ? 'checked' : '') !!}
                                            <span>{{ __('translation.active') }}</span>
                                        </label>
                                    </div>
                                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                        <label class="rdiobox">
                                            {!! Form::radio('status', 'inactive', (old('status', $partner->status)) == 'inactive' ? 'checked' : '') !!}
                                ...
                                <div class="row pt-4">
                                    <div class="col-12">
                                        ...
                                        <input type="file" name="img" class="dropify"  data-default-file="{{ $partner->image_path }}" accept=".jpg, .png, image/jpeg, image/png" data-height="70" />
