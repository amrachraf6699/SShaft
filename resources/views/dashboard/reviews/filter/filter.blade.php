<div class="card card-primary">
    <div class="card-body">
        {!! Form::open(['route' => 'dashboard.reviews.index', 'method' => 'get']) !!}
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::select('service_id', ['' => trans('translation.service_filter')] + $services->toArray(), old('service_id', request()->input('service_id')), ['class' => 'form-control select2']) !!}
                    </div>
                </div>
                <div class="col-md-1">
                    <div class="form-group">
