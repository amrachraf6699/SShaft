						...
						<div class="card card-primary">
							<div class="card-header py-3 d-flex">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('dashboard.paid-donations.export') }}?keyword={{ request('keyword') }}&branch_id={{ request('branch_id') }}&service_id={{ request('service_id') }}&payment_ways={{ request('payment_ways') }}&sort_by={{ request('sort_by') }}&order_by={{ request('order_by') }}&limit_by={{ request('limit_by') }}" class="btn btn-purple btn-with-icon mr-2">
                                        ...
                                        <tbody>
                                            @foreach ($donations as $donation)
                                                <tr>
                                                    ...
                                                    <td>{{ $donation->payment_brand == 'SPAN' ? 'MADA' : $donation->payment_brand }}</td>
                                                    <td>
