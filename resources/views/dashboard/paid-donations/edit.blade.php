                        ...
                        <div class="card card-primary">
                            <div class="card-header py-3 d-flex">
                                <div class="d-flex justify-content-between">
                                    <a href="{{  route('dashboard.paid-donations.index') }}" class="btn btn-primary btn-with-icon btn-block">
                                        {{ __('translation.paid_donations') }}
                                    </a>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-lg-3">
                                        <label class="rdiobox">
                                            {!! Form::radio('send_sms', 'yes', false, [old('send_sms')]) !!}
                                            <span>{{ __('أجل') }}</span>
                                        </label>
                                    </div>
                                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                        <label class="rdiobox">
                                            {!! Form::radio('send_sms', 'no', true, [old('send_sms')]) !!}
                                            <span>{{ __('لا') }}</span>
                                        </label>
                                    </div>
