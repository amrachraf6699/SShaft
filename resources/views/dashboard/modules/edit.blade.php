...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('translation.modules') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.update') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                {!! Form::open(['route' => ['dashboard.modules.update', $module->id], 'method' => 'post', 'files' => true]) !!}
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            {!! Form::label('module_section_id', trans('translation.section')) !!}
                                            {!! Form::select('module_section_id', ['' => trans('translation.select')] + $sections->toArray(), old('module_section_id', $module->module_section_id), ['class' => 'form-control select2']) !!}
                                            @error('module_section_id')<span class="text-danger">{{ $message }}</span>@enderror
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('title', old('title', $module->title), ['class' => 'form-control']) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('content', old('content', $module->content), ['class' => 'form-control summernote', 'rows' => 4]) !!}
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-lg-3">
                                        <label class="rdiobox">
                                            {!! Form::radio('status', 'active', (old('status', $module->status)) == 'active' ? 'checked' : '') !!}
                                            <span>{{ __('translation.active') }}</span>
                                        </label>
                                    </div>
                                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                        <label class="rdiobox">
                                            {!! Form::radio('status', 'inactive', (old('status', $module->status)) == 'inactive' ? 'checked' : '') !!}
                                ...
                                <div class="row pt-4">
                                    <div class="col-12">
                                        {!! Form::label('file', trans('translation.file')) !!}
                                        <p class="text-danger">* صيغة المرفق  pdf </p>
                                        <br>
                                        <input type="file" name="file" class="dropify" data-default-file="{{ $module->file_path }}" accept=".pdf" data-height="70" />
