...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ __('translation.neighborhoods') }}</h4>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
...
@section('content')
				...
				<div class="row row-sm">
					<!--div-->
					<div class="col-md-12">
                        @include('dashboard.neighborhoods.filter.filter')
						<div class="card card-primary">
							<div class="card-header py-3 d-flex">
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('dashboard.neighborhoods.create') }}" class="btn btn-primary btn-with-icon btn-block">
                                    ...
                                    <table id="datatable" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($neighborhoods as $neighborhood)
                                                <tr>
                                                    <td><input type="checkbox" value="{{$neighborhood->id}}" class="box1"></td>
                                                    ...
                                                    <td>
                                                        <div class="btn-icon-list">
                                                            {{-- neighborhood edit --}}
                                                            <a href="{{ route('dashboard.neighborhoods.edit', $neighborhood->id) }}" class="btn btn-primary btn-icon"><i class="typcn typcn-pencil"></i></a>
                                                            {{-- neighborhood delete --}}
                                                            <form action="{{ route('dashboard.neighborhoods.destroy', $neighborhood->id) }}" method="post" style="display: inline-block">
                                                                @csrf
                                                                @method('DELETE')
                                            ...
                                            <tr>
                                                <th colspan="12">
                                                    <div class="float-right">
                                                        {!! $neighborhoods->appends(request()->input())->links() !!}
                                                    </div>
                                                </th>
                                            </tr>
                                        </tfoot>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('dashboard.neighborhoods.destroy_all') }}" method="POST">
                        @csrf
                        @method('DELETE')
