...
@section('content')
    <section class="page-header">
        ...
        <div class="container">
            ...
            <a href="{{ route('frontend.beneficiaries-requests.section.show', $section->slug) }}" class="thm-btn">
                <i class="fas fa-users"></i> حالات واردة
            </a>
        </div><!-- /.container -->
    </section><!-- /.page-header -->
                                    ...
                                    <div class="cause-card__content">
                                        ...
                                        <form class="service-form" action="{{ route('frontend.service.cart.store', $service->id) }}" method="POST">
                                            ...
                                            <div class="cause-card__bottom">
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#exampleModal3{{ $service->id }}" class="thm-btn dynamic-radius">تبرع الان</a>
        ...
        $(function() {
            $(document).on('click', '#ckeckout', function(e) {
                ...
                if (paymentWays != 'bank_transfer') {
                    ...
                    $.ajax({
                        type: 'get',
                        url: "{{ route('frontend.all-services.service.check-out') }}",
                        data: {
