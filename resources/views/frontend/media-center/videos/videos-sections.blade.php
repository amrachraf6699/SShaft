...
@section('content')
    ...
    @if ($sections->count() > 0)
        <section class="gallery-page pt-120 pb-120">
            <div class="container">
                <h3 class="address">أقسام الفيديو</h3>
                            ...
                            <div class="gallery-card">
                                ...
                                <div class="gallery-content">
                                    <a href="{{ $section->image_path }}" class="img-popup" aria-label="open image">
                                        <div><i class="fa fa-list-ul"></i><strong> {{ $section->videos_count }}</strong></div>
                                        {{-- <div><i class="fa fa-eye"></i><strong>732</strong></div> --}}
                                    </a>
                                </div><!-- /.gallery-content -->
                            </div><!-- /.gallery-card -->
                            <h5><a href="{{ route('frontend.videos.index', $section->slug) }}">{{ $section->title }}</a></h5>
                        </div>
                    @endforeach
                </div><!-- /.gallery-3-col -->
